% Editable slide deck entrypoint for MediFlow.
%
% This file holds the curated structure of the deck. All numbers, tables,
...
\colorlet{tablerule}{navy!55!black}
...
\setlength{\heavyrulewidth}{1.35pt}
